...
Training code for KINGPT was forked directly from the (nanoGPT)[https://github.com/karpathy/nanoGPT] repository. I would highly recommend just to follow the instructions there on how to hack it to your needs instead of reading my config.
